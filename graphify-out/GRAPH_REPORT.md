...
## Corpus Check
- 156 files · ~73,316 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 390 nodes · 423 edges · 51 communities (25 shown, 26 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 53 edges (avg confidence: 0.88)
...
Cohesion: 0.14
Nodes (18): Mandatory Graphify Pre-Task Protocol, Parallel Tasks File Format (Task Block Structure), docs/ Customization Prompt (setup-docs.md), AGENTS.md Reference to base-standards.md, CLAUDE.md Reference to base-standards.md (Reactivities sub), GEMINI.md Reference to base-standards.md, ai-specs/skills Reusable Workflow Skills, base-standards.md Single Source of Truth Principle (+10 more)
...
## Knowledge Gaps
- **195 isolated node(s):** `husky.sh script`, `code_review.sh script`, `net10.0`, `Microsoft.EntityFrameworkCore.Design (10.0.8)`, `Microsoft.NET.Sdk.Web` (+190 more)
...
- **Why does `OpenSpec config.yaml for Reactivities` connect `Reactivities Architecture Docs` to `Multi-Copilot Agent Config`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **What connects `husky.sh script`, `code_review.sh script`, `net10.0` to the rest of the system?**
