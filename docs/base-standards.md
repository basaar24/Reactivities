...
- **Type Safety**: All code must be fully typed — C# `required` properties and TypeScript `strict` mode enforced.
- **Clear Naming**: Use clear, descriptive names for all variables, functions, classes, and files.
...
- [Data Model](./data-model.md) — Entity definitions, field types, and ER diagram
- [API Spec](./api-spec.yml) — OpenAPI 3.0.3 specification for all endpoints
